...
- 新しい水替えログでは、誕生・飼育日数・大きさ・季節に合う1,000種類のセリフから、無害で少し怪しい水槽内の出来事と、本人は気にしていない軽い自虐を中心にしたまりものひとことを「名前「セリフ」」の形で表示する。利用者を採点・指示・揶揄する口調は使わない。同じ利用者の直近7件とは文章だけでなく同じ前半・オチもできるだけ重複させず、選んだセリフは水替え記録へ保存する。
