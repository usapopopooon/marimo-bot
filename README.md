...
- 枯れた後は、次回の水替えで新しい世代を始めるか、`1,000 XP` または重複分の「苔コーラ」1本で同じまりもを復活できる。苔コーラはコレクションに残す最初の1本を消費しない。
- 死亡ログの「苔コーラを与える」から、別のユーザーのまりもも復活できる。最初に確定した1人だけが消費し、古い死亡ログや復活済みのまりもへの操作では消費しない。持ち主が次の世代を育て始めたら旧世代は復活対象外となり、救助ボタンも表示しない。
