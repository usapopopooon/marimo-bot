...
- 死亡ログの「苔コーラを与える」から、別のユーザーのまりもも復活できる。苔コーラを消費する前にボタンを押した人だけへ確認を表示し、最初に確定した1人だけが消費する。古い死亡ログや復活済みのまりもへの操作では消費しない。持ち主が次の世代を育て始めたら旧世代は復活対象外となり、救助ボタンと案内も表示しない。
