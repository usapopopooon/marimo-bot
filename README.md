...
- 枯れると次回の水替え時に新しい世代が生まれ、大きさ・連続飼育日数・水替えXPはリセットされる。
...
一般ユーザーは埋め込み形式の水替えパネルにある「育て始める・水を替える」「自分のまりも」「名前をつける」ボタンだけで操作する。初回は自分のまりもが生まれ、以後は同じボタンで1日1回水を替える。大きさランキングも埋め込み形式で常設する。
